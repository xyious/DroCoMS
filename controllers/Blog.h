...
class Blog : public drogon::HttpController<Blog>
{
  public:
    ...
    ADD_METHOD_TO(Blog::renderArchive, "/Archive", drogon::Get);
    ...
    void renderArchive(const drogon::HttpRequestPtr& req, std::function<void (const drogon::HttpResponsePtr &)> &&callback, std::string category);
    void renderHome(const drogon::HttpRequestPtr& req, std::function<void (const drogon::HttpResponsePtr &)> &&callback, std::string category);
